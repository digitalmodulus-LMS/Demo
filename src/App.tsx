...
const App: React.FC = () => {
  ...
  const renderContent = useMemo(() => {
    ...
    switch (currentUser.role) {
      case Role.Admin:
        // For admin, we need to decide which page to show based on currentPage
        return <AdminDashboard navigate={navigate} />;
      case Role.Trainer:
         // For trainer, we need to decide which page to show based on currentPage
        return <TrainerDashboard navigate={navigate} />;
      case Role.Learner:
         // For learner, we need to decide which page to show based on currentPage
